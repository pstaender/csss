...
DocumentStyle = (function() {
  ...
  DocumentStyle.prototype.addLine = function(line, addTrailingSemicolon) {
    return this.add(addTrailingSemicolon ? line.replace(/\;+\s*$/, ';') : line);
  };
  ...
  DocumentStyle.prototype.charset = function(charset) {
    if (charset) {
      return this.addLine("@charset '" + charset + "';");
    }
  };
  ...
  DocumentStyle.prototype.page = function(selector, values) {
    ...
    if (selector) {
      return this.addLine("@page " + selector + " " + values);
    }
  };
  ...
  DocumentStyle.prototype.font_face = function(query) {
    return this.add('@font-face', query);
  };
...
CSSS = (function() {
  ...
  CSSS.prototype.processStyleText = function() {
    var changedLine, i, indentSpacesCount, isInListedValues, lastLineWithSelector, lastSelectorLine, line, lineBefore, lineBeginsWithAttribute, lines, matches, nextLine, originalLines, styletext, whitespaces, _i, _len;
    ...
    for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
      ...
      if (this.pattern.isCSSQuery.test(line)) {
        ...
        if ((this.doesLineBeginsWithAttribute(lineBefore) && nextLine && this._indentSpacesOfLine(nextLine) === indentSpacesCount) || isInListedValues) {
          if (!isInListedValues && this.doesLineHaveOnlyAttribute(lineBefore)) {
            lines[i - 1] += ' [';
          }
          isInListedValues = /^\s+[\#a-zA-Z\_\-0-9\(\)\.]+/.test(line) || /^\s+\@/.test(line);
          ...
          lines[i] = line;
          if (!nextLine || (nextLine && this._indentSpacesOfLine(nextLine) !== indentSpacesCount)) {
            line += ' ]';
  ...
  CSSS.prototype.css = function(cssString, o) {
    var before, i, insideParts, isNormalSelector, isReference, level, levelBefore, levels, mediaQuery, parts, s, section, selector, selectorBefore, selectorString, values, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _s;
        ...
        if (level < levelBefore && (levels != null ? levels[level - 1] : void 0)) {
          ...
          if (isReference) {
            parts = (function() {
              ...
              _ref4 = selectorString.substring(1).split(',');
              _results = [];
              for (_k = 0, _len1 = _ref4.length; _k < _len1; _k++) {
                ...
                insideParts = (function() {
                  var _l, _len2, _ref5, _results1;

                  _ref5 = levels[level - 1].trim().split(',');
                  _results1 = [];
